    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 gradient-hero">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        <p className="mb-8 text-xs font-semibold tracking-[0.4em] uppercase text-primary">
          Proposta Comercial · PR Bombas · Yuri Correia · 2026
        </p>
        ...
        <p className="mt-6 heading-display text-3xl font-bold sm:text-4xl md:text-5xl neon-text">
          PR Bombas no digital que ela merece.
        </p>

        <p className="mt-8 text-lg text-muted-foreground sm:text-xl max-w-2xl mx-auto leading-relaxed text-balance">
          A PR Bombas tem produto, tem reputação e tem mercado.{" "}
          <span className="font-semibold text-foreground">
            O que falta é um site que mostre isso com clareza — e converta visitante em cliente.
          </span>
        </p>
        ...
        <div className="mt-8 flex items-center justify-center gap-6 text-sm text-muted-foreground flex-wrap">
          ...
          <span className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: "hsl(36 95% 50%)" }} />
            3 bônus exclusivos
          </span>
        </div>
        ...
        <button
          ...
          className="mt-12 inline-flex items-center gap-3 rounded-full border border-primary/40 bg-primary px-8 py-4 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 hover:shadow-[0_4px_20px_hsl(209_80%_38%/0.3)]"
        >
